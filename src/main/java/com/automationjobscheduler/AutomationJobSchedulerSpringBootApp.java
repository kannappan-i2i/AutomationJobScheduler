...
public class AutomationJobSchedulerSpringBootApp {
    ...
    public CommandLineRunner demoData(
        ...
        return (args) -> {
            ...
            // 1hour time slot
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(0, 0), LocalTime.of(0, 59,59),1, DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(1, 0), LocalTime.of(1, 59,59),1, DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(2, 0), LocalTime.of(2, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(3, 0), LocalTime.of(3, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(4, 0), LocalTime.of(4, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(5, 0), LocalTime.of(5, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(6, 0), LocalTime.of(6, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(7, 0), LocalTime.of(7, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(8, 0), LocalTime.of(8, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(9, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(10, 0), LocalTime.of(10, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(11, 0), LocalTime.of(11, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(12, 0), LocalTime.of(12, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(13, 0), LocalTime.of(13, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(14, 0), LocalTime.of(14, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(15, 0), LocalTime.of(15, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(16, 0), LocalTime.of(16, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(17, 0), LocalTime.of(17, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(18, 0), LocalTime.of(18, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(19, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(20, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(21, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(22, 59,59),1,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(23, 59, 59),1,DayOfWeek.MONDAY));

            //2 hour time slot
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(0, 0), LocalTime.of(1, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(1, 0), LocalTime.of(2, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(2, 0), LocalTime.of(3, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(3, 0), LocalTime.of(4, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(4, 0), LocalTime.of(5, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(5, 0), LocalTime.of(6, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(6, 0), LocalTime.of(7, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(7, 0), LocalTime.of(8, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(8, 0), LocalTime.of(9, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(10, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(10, 0), LocalTime.of(11, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(11, 0), LocalTime.of(12, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(12, 0), LocalTime.of(13, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(13, 0), LocalTime.of(14, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(14, 0), LocalTime.of(15, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(15, 0), LocalTime.of(16, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(16, 0), LocalTime.of(17, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(17, 0), LocalTime.of(18, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(18, 0), LocalTime.of(19, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(20, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(21, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(22, 59,59),2,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(23, 59, 59),2,DayOfWeek.MONDAY));

            //3 hour time slot
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(0, 0), LocalTime.of(2, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(1, 0), LocalTime.of(3, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(2, 0), LocalTime.of(4, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(3, 0), LocalTime.of(5, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(4, 0), LocalTime.of(6, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(5, 0), LocalTime.of(7, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(6, 0), LocalTime.of(8, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(7, 0), LocalTime.of(9, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(8, 0), LocalTime.of(10, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(11, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(10, 0), LocalTime.of(12, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(11, 0), LocalTime.of(13, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(12, 0), LocalTime.of(14, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(13, 0), LocalTime.of(15, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(14, 0), LocalTime.of(16, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(15, 0), LocalTime.of(17, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(16, 0), LocalTime.of(18, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(17, 0), LocalTime.of(19, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(18, 0), LocalTime.of(20, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(21, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(22, 59,59),3,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(23, 59,59),3,DayOfWeek.MONDAY));

            //5 hour time slot
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(0, 0), LocalTime.of(4, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(1, 0), LocalTime.of(5, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(2, 0), LocalTime.of(6, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(3, 0), LocalTime.of(7, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(4, 0), LocalTime.of(8, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(5, 0), LocalTime.of(9, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(6, 0), LocalTime.of(10, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(7, 0), LocalTime.of(11, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(8, 0), LocalTime.of(12, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(13, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(10, 0), LocalTime.of(14, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(11, 0), LocalTime.of(15, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(12, 0), LocalTime.of(16, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(13, 0), LocalTime.of(17, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(14, 0), LocalTime.of(18, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(15, 0), LocalTime.of(19, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(16, 0), LocalTime.of(20, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(17, 0), LocalTime.of(21, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(18, 0), LocalTime.of(22, 59,59),5,DayOfWeek.MONDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(23, 59,59),5,DayOfWeek.MONDAY));

            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(18, 0), LocalTime.of(00, 59,59),7,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(18, 0), LocalTime.of(01, 59,59),8,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(00, 59,59),6,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(01, 59,59),7,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(19, 0), LocalTime.of(02, 59,59),8,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(00, 59,59),5,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(01, 59,59),6,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(02, 59,59),7,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(20, 0), LocalTime.of(03, 59,59),8,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(00, 59,59),4,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(01, 59,59),5,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(02, 59,59),6,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(03, 59,59),7,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(21, 0), LocalTime.of(04, 59,59),8,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(00, 59,59),3,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(01, 59,59),4,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(02, 59,59),5,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(03, 59,59),6,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(04, 59,59),7,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(22, 0), LocalTime.of(05, 59,59),8,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(00, 59,59),2,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(01, 59,59),3,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(02, 59,59),4,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(03, 59,59),5,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(04, 59,59),6,DayOfWeek.TUESDAY));
            timeslotRepository.save(new Timeslot(DayOfWeek.MONDAY, LocalTime.of(23, 0), LocalTime.of(05, 59,59),7,DayOfWeek.TUESDAY));
            ...
            robotsRepository.save(new Robots("Robots G"));
            robotsRepository.save(new Robots("Robots H"));
            ...
            jobScheduledTime.put("startTime",LocalTime.of(0, 0, 0));
            jobScheduledTime.put("endTime",LocalTime.of(23, 59,59 ));

            HashMap<String, LocalTime> jobScheduledTime1 = new HashMap<>();
            jobScheduledTime1.put("startTime",LocalTime.of(1, 0,0 ));
            jobScheduledTime1.put("endTime",LocalTime.of(10, 59,59));
            ...
            jobScheduledTime3.put("startTime",LocalTime.of(0, 0,0 ));
            jobScheduledTime3.put("endTime",LocalTime.of(21, 59, 59));
